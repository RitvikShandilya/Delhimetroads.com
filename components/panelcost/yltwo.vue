...
<v-row class="justify-center">
    <v-dialog v-model="dialyltwo" fullscreen transition="dialog-bottom-transition" :overlay=false lazy>

      <v-card color="grey lighten-5" flat>
        <v-toolbar light style="background-image: linear-gradient(120deg, #f6d365 0%, #fda085 100%);" extended flat>
          <v-toolbar-title class="subtitle-1">Cost Estimation - Yellow Line Bombardier Trains</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
            <v-btn icon @click.native="toggledialyltwo" dark>
